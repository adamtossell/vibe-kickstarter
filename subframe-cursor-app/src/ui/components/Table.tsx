...
/*
 * Documentation:
 * Table — https://app.subframe.com/e11df886f842/library?component=Table_142dfde7-d0cc-48a1-a04c-a08ab2252633
  ...
  return (
    <tr
      className={SubframeUtils.twClassNames(
        "group/5d119f8d border-t border-solid border-neutral-200",
...
const TableRoot = React.forwardRef<HTMLElement, TableRootProps>(
  function TableRoot(
    ...
    return (
      ...
      >
        <thead>{header}</thead>
        <tbody className="border-b border-solid border-neutral-200">
          {children}
        </tbody>
      </table>
    );
