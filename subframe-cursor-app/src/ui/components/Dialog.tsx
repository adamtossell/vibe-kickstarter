...
/*
 * Documentation:
 * Dialog — https://app.subframe.com/e11df886f842/library?component=Dialog_ca59db17-43fb-4247-8094-3c55162e902d
 */
    ...
    <SubframeCore.Dialog.Content asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex min-w-[320px] flex-col items-start gap-2 rounded-md border border-solid border-neutral-200 bg-default-background shadow-lg max-h-[90vh] overflow-auto",
          className
        )}
        ref={ref as any}
      >
