...
/*
 * Documentation:
 * Select — https://app.subframe.com/e11df886f842/library?component=Select_bb88f90b-8c43-4b73-9c2f-3558ce7838f3
 */
    ...
    >
      <div
        className={SubframeUtils.twClassNames(
          "group/969e345b flex h-8 w-full cursor-pointer items-center gap-1 rounded-md px-3 hover:bg-neutral-100 active:bg-neutral-50 data-[state=checked]:bg-neutral-100 data-[highlighted]:bg-neutral-100",
          className
        )}
        ref={ref as any}
      >
...
const Content = React.forwardRef<HTMLElement, ContentProps>(function Content(
  ...
  return children ? (
    <SubframeCore.Select.Content asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex w-full flex-col items-start overflow-hidden rounded-md border border-solid border-neutral-200 bg-white px-1 py-1 shadow-lg",
          className
        )}
        ref={ref as any}
      >
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={SubframeUtils.twClassNames(
              "flex h-8 w-full flex-none flex-col items-start rounded-md border border-solid border-neutral-200 bg-default-background group-focus-within/bb88f90b:border group-focus-within/bb88f90b:border-solid group-focus-within/bb88f90b:border-brand-primary",
              {
