      ...
      >
        ...
        <div
          className={SubframeUtils.twClassNames(
            ...
            {
              "border border-solid border-neutral-100 bg-neutral-50 group-hover/be48ca43:border group-hover/be48ca43:border-solid group-hover/be48ca43:border-neutral-200 group-hover/be48ca43:bg-neutral-100 group-focus-within/be48ca43:bg-neutral-100":
                variant === "filled",
