...
/*
 * Documentation:
 * Context Menu — https://app.subframe.com/e11df886f842/library?component=Context+Menu_f8a49f07-fa5b-46c8-9399-cbbf0930cc62
...
const ContextMenuRoot = React.forwardRef<HTMLElement, ContextMenuRootProps>(
  function ContextMenuRoot(
    ...
    return children ? (
      <div
        className={SubframeUtils.twClassNames(
          "flex min-w-[192px] flex-col items-start rounded-md border border-solid border-neutral-200 bg-default-background px-1 py-1 shadow-lg",
          className
        )}
        ref={ref as any}
        {...otherProps}
