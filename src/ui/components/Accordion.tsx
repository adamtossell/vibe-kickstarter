...
/*
 * Documentation:
 * Accordion — https://app.subframe.com/e11df886f842/library?component=Accordion_d2e81e20-863a-4027-826a-991d8910efd9
 */
  ...
  function AccordionRoot(
    ...
    return (
      <SubframeCore.Collapsible.Root asChild={true} {...otherProps}>
        <div
          className={SubframeUtils.twClassNames(
            "group/d2e81e20 flex w-full flex-col items-start rounded-md flex-nowrap gap-2 data-[state=open]:flex-col data-[state=open]:flex-nowrap data-[state=open]:gap-2",
            className
          )}
          ref={ref as any}
        >
